<?php /* Smarty version 2.6.18, created on 2014-10-21 09:27:23
         compiled from report_a_problem.tpl */ ?>
						...
						<tbody class="structure_table1">
							<tr>
								<td>		
									<span>Send to</span> 
									<select name="send_to">
										<?php $_from = $this->_tpl_vars['send_to_tab']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
