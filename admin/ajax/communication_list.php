...
$query .= " AND (fromuserid='".$_SESSION['user']['userid']."' OR touserid='".$_SESSION['user']['userid']."')";
...
<table class="list1_1" cellspacing="0">	
	<thead>
		...
		<tr class="list1_1_sort">
			...
			<? } ?>
			<? if ($_SESSION['page_settings_tab']['answering'] == 1) { ?>
				<td style="width:30px;" class="tcenter"><a href="#"><span>Answer</span></a></td>
			<? } ?>
			<? if ($_SESSION['page_settings_tab']['forwarding'] == 1) { ?>
				<td style="width:30px;" class="tcenter"><a href="#"><span>Forward</span></a></td>
			<? } ?>
	...
	<tbody id="sortable" class="structure_table1">
		<? if ($data_tab1 != '') { ?>
			<? foreach ($data_tab1 as $id => $val) { ?>
				...
				<?	if ($data_tab1[$id]['opened'] == 0) { ?>
					<tr class="elemstr elemstr_not_opened structure_table1_tr1" id="elemstr_<? echo  $id; ?>" class="ui-state-default">
				...
				<? } ?>
					...
					<? } ?> 
					<? if ($_SESSION['page_settings_tab']['answering'] == 1) { ?>		
						<td class="tcenter list1_1_1" style="width:30px;">
							<? if ($data_tab1[$id]['touserid'] == $_SESSION['user']['userid']) { ?>
								<a onclick="element_answer(<? echo $id; ?>);" class="edit_iko"><span>&nbsp;</span></a>
							<? } else { ?>
								<a><span>&nbsp;</span></a>								
							<? } ?>
						</td>
					...
					<? } ?> 
					<? if ($_SESSION['page_settings_tab']['forwarding'] == 1) { ?>		
						<td class="tcenter list1_1_1" style="width:30px;"><a onclick="element_answer(<? echo $id; ?>);" class="edit_iko"><span>&nbsp;</span></a></td>
					<? } ?> 
				</tr>
			<? } ?> 
		<? } else { ?>
