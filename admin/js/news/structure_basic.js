...
function clear_bigselect_element(id1,type1) {			
	...
	$.post("ajax/news/structure_basic.php", {'action': 'clear_bigselect_element','id1': id1},  function(data){
		reload_list0();
	});			
}
...
function search_for_bigselect_element_select(id1,key1,val,type1) {		
	...
	/*
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'filter_bigselect_save','filter_bigselect': filter_bigselect,'key1': key1},  function(data){
...
function filter1_bigselect(key1) {
	...
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'filter_bigselect','filter_bigselect': filter_bigselect,'key1': key1},  function(data){
		search_for_bigselect_element(key1);
		loading02(); 
	});				
}
...
function change_pagination_bigselect(amount,key1) {
	...
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'change_pagination_bigselect','amount': amount,'key1': key1},  function(data){
		search_for_bigselect_element(key1);
		loading02(); 
	});				
}
...
function change_pagination(amount) {	
	...
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'change_pagination','amount': amount},  function(data){
		reload_list0();
		loading02(); 
	});				
}
...
function show_entries(amount) {	
	...
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'show_entries','amount': amount},  function(data){
		reload_list0();
		loading02(); 
	});				
}
...
function filter1() {	
	...
	$.post("ajax/news/structure_basic.php", {'action': 'filter1','save_parameters_id_tab':  save_parameters_id_tab,
...
function sort1(sort1,sort2) {	
	...
	loading01(); 
	$.post("ajax/news/structure_basic.php", {'action': 'sort1','sort1': sort1,'sort2': sort2},  function(data){
		reload_list0();
		loading02(); 
	});			
}
...
function save_positions() {	
	...
	$.post("ajax/news/structure_basic.php", {'parent_id': parent_id,'action': 'save_position','elemstr_pos': elemstr_pos},  function(data){
...
function save_add_element(element_id) {
	...
	$.post("ajax/news/structure_basic.php", {'element_id': element_id,'action': 'add_element','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
...
function save_delete_element(element_id,element_id1,attachetname) {		
	...
	loading01(); 		
	$.post("ajax/news/structure_basic.php", {'element_id': element_id,'action': 'delete_element'},  function(data){
		reload_list(element_id);
		loading02(); 
	});			
}
...
function save_element_translations(element_id) {	
	...
	$.post("ajax/news/structure_basic.php", {'element_id': element_id,'action': 'save_translations','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
		//alert(data);
		save_changes_info('You changes has been saved :)');
		$('.popup').css('display','none');
...
function save_element_changes(element_id) {	
	...
	//alert('test');
	$.post("ajax/news/structure_basic.php", {'element_id': element_id,'action': 'save_details','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
		//alert(data);
		reload_list0();
		save_changes_info('You changes has been saved :)');
