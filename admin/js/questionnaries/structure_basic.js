...
function reload_list0() {
	...
	loading01(); 	
	$.post("ajax/questionnaries/structure_basic_list.php", {},  function(data){
...
function reload_list(element_id) {	
	...
	$.post("ajax/questionnaries/structure_basic_list.php", {'element_id': element_id,'save_parameters_id_tab': save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
		$("#structure_basic_list").html(data);
		save_changes_info('You changes has been saved :)');
		$('.popup').css('display','none');
