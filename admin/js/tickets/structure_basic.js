...
function reload_list0() {
	...
	loading01(); 	
	$.post("ajax/tickets/structure_basic_list.php", {},  function(data){
...
function element_edit(element_id) {	
	...
	loading01(); 
	$.post("php/popups/tickets/structure_basic.php", {'element_id': element_id},  function(data){
		$(".popup0").html(data);
		$(".focus_here").focus();
		tiny_mce_on();
		loading02();
...
function save_element_changes1(element_id,location1,location2) {	
	...
	$.post("ajax/tickets/structure_basic.php", {'element_id': element_id,'action': 'save_details','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab,'location1': location1,'location2': location2},  function(data){
