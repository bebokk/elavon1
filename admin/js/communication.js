...
function clear_bigselect_element(id1,type1) {			
	...
	$.post("ajax/communication.php", {'action': 'clear_bigselect_element','id1': id1},  function(data){
		reload_list0();
	});			
}
...
function search_for_bigselect_element_select(id1,key1,val,type1) {		
	...
	/*
	loading01(); 
	$.post("ajax/communication.php", {'action': 'filter_bigselect_save','filter_bigselect': filter_bigselect,'key1': key1},  function(data){
...
function filter1_bigselect(key1) {
	...
	loading01(); 
	$.post("ajax/communication.php", {'action': 'filter_bigselect','filter_bigselect': filter_bigselect,'key1': key1},  function(data){
		search_for_bigselect_element(key1);
		loading02(); 
	});				
}
...
function change_pagination_bigselect(amount,key1) {
	...
	loading01(); 
	$.post("ajax/communication.php", {'action': 'change_pagination_bigselect','amount': amount,'key1': key1},  function(data){
		search_for_bigselect_element(key1);
		loading02(); 
	});				
}
...
function change_pagination(amount) {	
	...
	loading01(); 
	$.post("ajax/communication.php", {'action': 'change_pagination','amount': amount},  function(data){
		reload_list0();
		loading02(); 
	});				
}
...
function show_entries(amount) {	
	...
	loading01(); 
	$.post("ajax/communication.php", {'action': 'show_entries','amount': amount},  function(data){
		reload_list0();
		loading02(); 
	});				
}
...
function filter1() {	
	...
	$.post("ajax/communication.php", {'action': 'filter1','save_parameters_id_tab':  save_parameters_id_tab,
...
function sort1(sort1,sort2) {	
	...
	loading01(); 
	$.post("ajax/communication.php", {'action': 'sort1','sort1': sort1,'sort2': sort2},  function(data){
		reload_list0();
		loading02(); 
	});			
}
...
function save_positions() {	
	...
	$.post("ajax/communication.php", {'parent_id': parent_id,'action': 'save_position','elemstr_pos': elemstr_pos},  function(data){
...
function element_add(element_id) {	
	...
	loading01(); 
	$.post("php/popups/communication_add.php", {'element_id': element_id},  function(data){
		$(".popup0").html(data);
		$(".focus_here").focus();
		tiny_mce_on();
		loading02(); 
...
function save_add_element1(element_id,location1,location2) {
	...
	$.post("ajax/communication.php", {'element_id': element_id,'action': 'add_element','save_parameters_id_tab':  save_parameters_id_tab,
...
function reload_list0() {
	...
	loading01(); 	
	$.post("ajax/communication_list.php", {},  function(data){
		$("#communication_list").html(data);
		loading02(); 
	});			
}
...
function reload_list(element_id) {	
	...
	$.post("ajax/communication_list.php", {'element_id': element_id,'save_parameters_id_tab': save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
		$("#communication_list").html(data);
		save_changes_info('You changes has been saved :)');
		$('.popup').css('display','none');
...
function save_delete_element(element_id,element_id1,attachetname) {		
	...
	loading01(); 		
	$.post("ajax/communication.php", {'element_id': element_id,'action': 'delete_element'},  function(data){
		reload_list(element_id);
		loading02(); 
	});			
}
...
function element_edit(element_id) {	
	...
	loading01(); 
	$.post("php/popups/communication.php", {'element_id': element_id},  function(data){
		$(".popup0").html(data);
		$(".focus_here").focus();
		tiny_mce_on();
		loading02();
...
function element_view(element_id) {	
	...
	loading01(); 
	$.post("php/popups/communication_view.php", {'element_id': element_id},  function(data){
		$(".popup0").html(data);
		$(".focus_here").focus();
		tiny_mce_on();
		loading02();
...
function element_answer(element_id) {	

	loading01(); 
	$.post("php/popups/communication_answer.php", {'element_id': element_id},  function(data){
		$(".popup0").html(data);
		$(".focus_here").focus();
		tiny_mce_on();
		loading02();
...
function save_element_translations(element_id) {	
	...
	$.post("ajax/communication.php", {'element_id': element_id,'action': 'save_translations','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab},  function(data){
		//alert(data);
		save_changes_info('You changes has been saved :)');
		$('.popup').css('display','none');
...
function save_element_changes1(element_id,location1,location2) {	
	...
	$.post("ajax/communication.php", {'element_id': element_id,'action': 'save_details','save_parameters_id_tab':  save_parameters_id_tab,
	'save_parameters_val_tab': save_parameters_val_tab,'location1': location1,'location2': location2},  function(data){
