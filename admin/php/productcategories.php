...
if ($_GET['details'] != '') {
	...
	include_once('php/productcategories_details.php');
	...
	include_once('php_save/productcategories.php');
	...
	drzewo_kategorii1($default_cat, $id_parent_ciag_wynik, $poziom, 'wybrane');
