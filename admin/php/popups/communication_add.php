						...
						<div class="popup1_s1">
							<table>
								...
								<? foreach ($elements_details1_tab['name'] as $key => $value) { ?>
									...
									<? } elseif ($elements_details1_tab['type'][$key] == 'select' AND $elements_details1_tab['edit'][$key] == 0) { ?>
										<tr>
											<td style="width:25%;"><? echo $value; ?></td>
											<td style="width:75%;" class="tleft">
												<? foreach ($elements_details1_tab['select'][$key] as $key1 => $value1) { ?>
													<input id="<? echo $key; ?>" class="popup1_content_input1 save_par <? echo $class1; ?>" type="hidden" name="<? echo $key; ?>" value="<? echo $key1; ?>" /> 
													<? echo $value1; ?>
												<? } ?>			
											</td>
										</tr>
