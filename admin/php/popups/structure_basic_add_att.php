...
$elements_details1_tab=$_SESSION['attachet_fields_list_tab'][$_POST['attachetname']];
			...
			<div class="popup1_content">
				<div class="popup1_content1">
					<div class="popup1_content1_1">
						<div class="popup1_content1_1_1"><span>Add element</span></div>
						<div class="popup1_s1">
							<table>
								<? $i=0; ?>
								<? foreach ($elements_details1_tab['name1'] as $key => $value) { ?>
									...
									<? if ($elements_details1_tab['type'][$key] == 'text') { ?>
										<tr>
											...
											<td style="width:85%;"><input id="<? echo $key; ?>" class="popup1_content_input1 save_par_att <? echo $class1; ?>" type="text" name="<? echo $key; ?>" value="<? echo $data1_tab[$key]; ?>" /></td>
										</tr>
						...
						<div class="popup1_content1_1_3">
							<a onclick="save_add_element_att(<? echo $_POST['element_id']; ?>,'<? echo $_POST['attachetname']; ?>');" class="popup1_content1_1_3_1">	
							...
							<input class="hidden_submit1" onclick="save_add_element_att(<? echo $_POST['element_id']; ?>,<? echo $_POST['attachetname']; ?>);" type="submit" name="add_element" value="add element" /></div>
						</div>							
						<!--
