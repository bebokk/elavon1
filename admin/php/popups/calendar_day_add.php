...
$data1_tab['nextactiondate']=$_POST['day'];
$data1_tab['nextactiontime']=$_POST['time'];
				...
				<div class="popup1_content1">
					<div class="popup1_content1_1">
								...
								<? foreach ($elements_details1_tab['name'] as $key => $value) { ?>
									...
									<? if ($elements_details1_tab['type'][$key] == 'text') { ?>
										<tr>
											...
											<td style="width:85%;"><input id="<? echo $key; ?>" class="popup1_content_input1 save_par <? echo $class1; ?>" type="text" name="<? echo $key; ?>" value="<? echo $data1_tab[$key]; ?>" /></td>
										</tr>
						...
						<div class="popup1_content1_1_3">
							...
							<input class="hidden_submit1" onclick="save_add_element(<? echo $_POST['element_id']; ?>);" type="submit" name="add_element" value="add element" /></div>
						</div>							
						<!--
